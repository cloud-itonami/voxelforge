...
//     documented dispatcher-facing Worker — does not call
...
// *different* upstream via ../src/dispatcher.ts — BPMN_DISPATCHER_URL, not
// AGENTGATEWAY_MCP_ROUTER_URL — with a different verb surface) is a product
// decision this migration does not make. It is recorded here, unmodified,
// so the next reader does not have to reconstruct it from git history.
